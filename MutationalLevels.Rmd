...
```{r eval=FALSE}
all_trees <- c(
  list.files(path = '/media/josephn/My_Passport/CovidRepertoire/CovidHB_alltrees/all_trees', full.names = TRUE),
  list.files(path = '/media/josephn/My_Passport/CovidRepertoire/otherReps_alltrees/newTrees', full.names = TRUE)
)
