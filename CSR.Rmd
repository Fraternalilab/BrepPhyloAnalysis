---
title: "Lineage and selection analysis of Covid Repertoires"
author: "Joseph Ng"
date: "8 April 2021"
...
tree_stats$SampleType2 <- apply(tree_stats[, c("startLabel", "endLabel", "PatientId")], MARGIN = 1, function(x){
  ...
  if(x[3] %in% c("EB215", "EB216", "EB217")) return("Ebola - White")
  if(x[3] %in% c("E2", "E50", "E14", "E82", "E15", "E43", "E46", "E70", "E75")) return("Ebola - West African")
...
tree_bySampleType$AgeGroup <- factor(tree_bySampleType$AgeGroup,
                                   levels = c("Unknown", "Young", "Middle", "Old"))
tree_bySampleType$SampleType2 <- factor(tree_bySampleType$SampleType2,
                                      levels = c("Healthy", "COVID-19", "Ebola - White", "Ebola - West African",
                                                 "RSV-I", "RSV-U", "YFVD28"),
                                      labels = c("Healthy", "COVID-19", "Ebola", "Ebola",
                                                 "RSV-I", "RSV-U", "YFVD28"))
...
## Timing of class switching events

Parsing arborescence graphs for CSR events and getting distances from germline.
...
tree_bySampleType$SampleType2 <- factor(tree_bySampleType$SampleType2,
                                          levels = c("Healthy", "COVID-19", "Ebola - White",
                                                     "RSV-I", "RSV-U", "Ebola - West African"))

ggplot(tree_bySampleType[which(tree_bySampleType$SampleType2 %in% 
                               c("Healthy", "COVID-19", "Ebola - White", "Ebola - West African", "RSV-I", "RSV-U") &
...
tree_byPatient$SampleType2 <- factor(tree_byPatient$SampleType2,
                                    levels = c("Healthy", "COVID-19", "Ebola - West African", "Ebola - White",
                                               "RSV-I", "RSV-U", "YFVD28"),
                                    labels = c("Healthy", "COVID-19", "Ebola (West African)", "Ebola (White)",
                                               "RSV-I", "RSV-U", "YFVD28"))
...
ggplot(tree_byPatient[which(tree_byPatient$CSR %in% timing_test$CSR),],
  ...
  facet_grid(~ CSR) + xlab("") + ylab("CSR timing") +
